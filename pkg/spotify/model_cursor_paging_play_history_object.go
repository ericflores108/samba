...
// checks if the CursorPagingPlayHistoryObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CursorPagingPlayHistoryObject{}

// CursorPagingPlayHistoryObject struct for CursorPagingPlayHistoryObject
...
func NewCursorPagingPlayHistoryObject() *CursorPagingPlayHistoryObject {
	this := CursorPagingPlayHistoryObject{}
	return &this
}
...
func (o CursorPagingPlayHistoryObject) MarshalJSON() ([]byte, error) {
...
func (o CursorPagingPlayHistoryObject) ToMap() (map[string]interface{}, error) {
...
type NullableCursorPagingPlayHistoryObject struct {
	value *CursorPagingPlayHistoryObject
	isSet bool
}

func (v NullableCursorPagingPlayHistoryObject) Get() *CursorPagingPlayHistoryObject {
	return v.value
}

func (v *NullableCursorPagingPlayHistoryObject) Set(val *CursorPagingPlayHistoryObject) {
	v.value = val
	v.isSet = true
}

func (v NullableCursorPagingPlayHistoryObject) IsSet() bool {
	return v.isSet
}

func (v *NullableCursorPagingPlayHistoryObject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCursorPagingPlayHistoryObject(val *CursorPagingPlayHistoryObject) *NullableCursorPagingPlayHistoryObject {
	return &NullableCursorPagingPlayHistoryObject{value: val, isSet: true}
}

func (v NullableCursorPagingPlayHistoryObject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCursorPagingPlayHistoryObject) UnmarshalJSON(src []byte) error {
	v.isSet = true
