...
// checks if the PagingSavedTrackObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PagingSavedTrackObject{}

// PagingSavedTrackObject struct for PagingSavedTrackObject
...
type _PagingSavedTrackObject PagingSavedTrackObject
...
func (o PagingSavedTrackObject) MarshalJSON() ([]byte, error) {
...
func (o PagingSavedTrackObject) ToMap() (map[string]interface{}, error) {
...
func (o *PagingSavedTrackObject) UnmarshalJSON(data []byte) (err error) {
	...
	varPagingSavedTrackObject := _PagingSavedTrackObject{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPagingSavedTrackObject)

	if err != nil {
		return err
	}

	*o = PagingSavedTrackObject(varPagingSavedTrackObject)

	return err
}

type NullablePagingSavedTrackObject struct {
	value *PagingSavedTrackObject
	isSet bool
}

func (v NullablePagingSavedTrackObject) Get() *PagingSavedTrackObject {
	return v.value
}

func (v *NullablePagingSavedTrackObject) Set(val *PagingSavedTrackObject) {
	v.value = val
	v.isSet = true
}

func (v NullablePagingSavedTrackObject) IsSet() bool {
	return v.isSet
}

func (v *NullablePagingSavedTrackObject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePagingSavedTrackObject(val *PagingSavedTrackObject) *NullablePagingSavedTrackObject {
	return &NullablePagingSavedTrackObject{value: val, isSet: true}
}

func (v NullablePagingSavedTrackObject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePagingSavedTrackObject) UnmarshalJSON(src []byte) error {
	v.isSet = true
