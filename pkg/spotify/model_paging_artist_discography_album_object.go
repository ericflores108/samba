...
// checks if the PagingArtistDiscographyAlbumObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PagingArtistDiscographyAlbumObject{}

// PagingArtistDiscographyAlbumObject struct for PagingArtistDiscographyAlbumObject
...
type _PagingArtistDiscographyAlbumObject PagingArtistDiscographyAlbumObject
...
func NewPagingArtistDiscographyAlbumObject(href string, limit int32, next NullableString, offset int32, previous NullableString, total int32, items []ArtistDiscographyAlbumObject) *PagingArtistDiscographyAlbumObject {
	this := PagingArtistDiscographyAlbumObject{}
	this.Href = href
	this.Limit = limit
	this.Next = next
	this.Offset = offset
...
func (o *PagingArtistDiscographyAlbumObject) GetOffset() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
func (o *PagingArtistDiscographyAlbumObject) GetItems() []ArtistDiscographyAlbumObject {
	if o == nil {
		var ret []ArtistDiscographyAlbumObject
		return ret
	}
...
func (o PagingArtistDiscographyAlbumObject) MarshalJSON() ([]byte, error) {
...
func (o PagingArtistDiscographyAlbumObject) ToMap() (map[string]interface{}, error) {
...
func (o *PagingArtistDiscographyAlbumObject) UnmarshalJSON(data []byte) (err error) {
	...
	varPagingArtistDiscographyAlbumObject := _PagingArtistDiscographyAlbumObject{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPagingArtistDiscographyAlbumObject)

	if err != nil {
		return err
	}

	*o = PagingArtistDiscographyAlbumObject(varPagingArtistDiscographyAlbumObject)

	return err
}

type NullablePagingArtistDiscographyAlbumObject struct {
	value *PagingArtistDiscographyAlbumObject
	isSet bool
}

func (v NullablePagingArtistDiscographyAlbumObject) Get() *PagingArtistDiscographyAlbumObject {
	return v.value
}

func (v *NullablePagingArtistDiscographyAlbumObject) Set(val *PagingArtistDiscographyAlbumObject) {
	v.value = val
	v.isSet = true
}

func (v NullablePagingArtistDiscographyAlbumObject) IsSet() bool {
	return v.isSet
}

func (v *NullablePagingArtistDiscographyAlbumObject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePagingArtistDiscographyAlbumObject(val *PagingArtistDiscographyAlbumObject) *NullablePagingArtistDiscographyAlbumObject {
	return &NullablePagingArtistDiscographyAlbumObject{value: val, isSet: true}
}

func (v NullablePagingArtistDiscographyAlbumObject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePagingArtistDiscographyAlbumObject) UnmarshalJSON(src []byte) error {
	v.isSet = true
