...
// checks if the ResumePointObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumePointObject{}

// ResumePointObject struct for ResumePointObject
...
func (o ResumePointObject) MarshalJSON() ([]byte, error) {
...
func (o ResumePointObject) ToMap() (map[string]interface{}, error) {
...
type NullableResumePointObject struct {
	value *ResumePointObject
	isSet bool
}

func (v NullableResumePointObject) Get() *ResumePointObject {
	return v.value
}

func (v *NullableResumePointObject) Set(val *ResumePointObject) {
	v.value = val
	v.isSet = true
}

func (v NullableResumePointObject) IsSet() bool {
	return v.isSet
}

func (v *NullableResumePointObject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumePointObject(val *ResumePointObject) *NullableResumePointObject {
	return &NullableResumePointObject{value: val, isSet: true}
}

func (v NullableResumePointObject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumePointObject) UnmarshalJSON(src []byte) error {
	v.isSet = true
