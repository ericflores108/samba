...
// checks if the PagingSimplifiedTrackObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PagingSimplifiedTrackObject{}

// PagingSimplifiedTrackObject struct for PagingSimplifiedTrackObject
...
func NewPagingSimplifiedTrackObject(href string, limit int64, next NullableString, offset int64, previous NullableString, total int64, items []SimplifiedTrackObject) *PagingSimplifiedTrackObject {
	this := PagingSimplifiedTrackObject{}
	this.Href = href
	this.Limit = limit
	this.Next = next
	this.Offset = offset
...
func (o PagingSimplifiedTrackObject) MarshalJSON() ([]byte, error) {
...
func (o PagingSimplifiedTrackObject) ToMap() (map[string]interface{}, error) {
...
func (o *PagingSimplifiedTrackObject) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varPagingSimplifiedTrackObject)
...
func (v NullablePagingSimplifiedTrackObject) Get() *PagingSimplifiedTrackObject {
	return v.value
}

func (v *NullablePagingSimplifiedTrackObject) Set(val *PagingSimplifiedTrackObject) {
	v.value = val
	v.isSet = true
}

func (v NullablePagingSimplifiedTrackObject) IsSet() bool {
	return v.isSet
}

func (v *NullablePagingSimplifiedTrackObject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePagingSimplifiedTrackObject(val *PagingSimplifiedTrackObject) *NullablePagingSimplifiedTrackObject {
	return &NullablePagingSimplifiedTrackObject{value: val, isSet: true}
}

func (v NullablePagingSimplifiedTrackObject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePagingSimplifiedTrackObject) UnmarshalJSON(src []byte) error {
	v.isSet = true
