...
// GetSupportsVolume returns the SupportsVolume field value if set, zero value otherwise.
func (o *DeviceObject) GetSupportsVolume() bool {
	if o == nil || IsNil(o.SupportsVolume) {
		var ret bool
		return ret
	}
	return *o.SupportsVolume
}

// GetSupportsVolumeOk returns a tuple with the SupportsVolume field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DeviceObject) GetSupportsVolumeOk() (*bool, bool) {
	if o == nil || IsNil(o.SupportsVolume) {
		return nil, false
	}
	return o.SupportsVolume, true
}
...
// SetSupportsVolume gets a reference to the given bool and assigns it to the SupportsVolume field.
...
func (o DeviceObject) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SupportsVolume) {
		toSerialize["supports_volume"] = o.SupportsVolume
	}
