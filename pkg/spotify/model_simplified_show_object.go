...
func (o *SimplifiedShowObject) UnmarshalJSON(data []byte) (err error) {
	...
	varSimplifiedShowObject := _SimplifiedShowObject{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSimplifiedShowObject)

	if err != nil {
		return err
	}

	*o = SimplifiedShowObject(varSimplifiedShowObject)
