...
// checks if the AudiobookObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AudiobookObject{}

// AudiobookObject struct for AudiobookObject
...
type _AudiobookObject AudiobookObject
...
func (o AudiobookObject) MarshalJSON() ([]byte, error) {
...
func (o AudiobookObject) ToMap() (map[string]interface{}, error) {
...
func (o *AudiobookObject) UnmarshalJSON(data []byte) (err error) {
	...
	varAudiobookObject := _AudiobookObject{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAudiobookObject)

	if err != nil {
		return err
	}

	*o = AudiobookObject(varAudiobookObject)

	return err
}

type NullableAudiobookObject struct {
	value *AudiobookObject
	isSet bool
}

func (v NullableAudiobookObject) Get() *AudiobookObject {
	return v.value
}

func (v *NullableAudiobookObject) Set(val *AudiobookObject) {
	v.value = val
	v.isSet = true
}

func (v NullableAudiobookObject) IsSet() bool {
	return v.isSet
}

func (v *NullableAudiobookObject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAudiobookObject(val *AudiobookObject) *NullableAudiobookObject {
	return &NullableAudiobookObject{value: val, isSet: true}
}

func (v NullableAudiobookObject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAudiobookObject) UnmarshalJSON(src []byte) error {
	v.isSet = true
