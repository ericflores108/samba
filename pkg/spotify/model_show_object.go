...
func (o *ShowObject) UnmarshalJSON(data []byte) (err error) {
	...
	varShowObject := _ShowObject{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varShowObject)

	if err != nil {
		return err
	}

	*o = ShowObject(varShowObject)
