...
// checks if the GetUsersTopArtistsAndTracks200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetUsersTopArtistsAndTracks200Response{}

// GetUsersTopArtistsAndTracks200Response struct for GetUsersTopArtistsAndTracks200Response
type GetUsersTopArtistsAndTracks200Response struct {
	...
	Items []GetUsersTopArtistsAndTracks200ResponseAllOfItemsInner `json:"items"`
}

type _GetUsersTopArtistsAndTracks200Response GetUsersTopArtistsAndTracks200Response
...
func NewGetUsersTopArtistsAndTracks200Response(href string, limit int64, next NullableString, offset int64, previous NullableString, total int64, items []GetUsersTopArtistsAndTracks200ResponseAllOfItemsInner) *GetUsersTopArtistsAndTracks200Response {
	this := GetUsersTopArtistsAndTracks200Response{}
	this.Href = href
	this.Limit = limit
	this.Next = next
	this.Offset = offset
...
func (o GetUsersTopArtistsAndTracks200Response) MarshalJSON() ([]byte, error) {
...
func (o GetUsersTopArtistsAndTracks200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetUsersTopArtistsAndTracks200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetUsersTopArtistsAndTracks200Response := _GetUsersTopArtistsAndTracks200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetUsersTopArtistsAndTracks200Response)

	if err != nil {
		return err
	}

	*o = GetUsersTopArtistsAndTracks200Response(varGetUsersTopArtistsAndTracks200Response)

	return err
}

type NullableGetUsersTopArtistsAndTracks200Response struct {
	value *GetUsersTopArtistsAndTracks200Response
	isSet bool
}

func (v NullableGetUsersTopArtistsAndTracks200Response) Get() *GetUsersTopArtistsAndTracks200Response {
	return v.value
}

func (v *NullableGetUsersTopArtistsAndTracks200Response) Set(val *GetUsersTopArtistsAndTracks200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetUsersTopArtistsAndTracks200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetUsersTopArtistsAndTracks200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetUsersTopArtistsAndTracks200Response(val *GetUsersTopArtistsAndTracks200Response) *NullableGetUsersTopArtistsAndTracks200Response {
	return &NullableGetUsersTopArtistsAndTracks200Response{value: val, isSet: true}
}

func (v NullableGetUsersTopArtistsAndTracks200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetUsersTopArtistsAndTracks200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
