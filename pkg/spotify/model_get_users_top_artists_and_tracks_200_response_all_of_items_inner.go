...
func (dst *GetUsersTopArtistsAndTracks200ResponseAllOfItemsInner) UnmarshalJSON(data []byte) error {
	...
	if err == nil {
		...
		if string(jsonArtistObject) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.ArtistObject); err != nil {
				dst.ArtistObject = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonTrackObject) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.TrackObject); err != nil {
				dst.TrackObject = nil
			} else {
				match++
			}
...
func (obj GetUsersTopArtistsAndTracks200ResponseAllOfItemsInner) GetActualInstanceValue() (interface{}) {
	if obj.ArtistObject != nil {
		return *obj.ArtistObject
	}
