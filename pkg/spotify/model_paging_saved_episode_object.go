...
// checks if the PagingSavedEpisodeObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PagingSavedEpisodeObject{}

// PagingSavedEpisodeObject struct for PagingSavedEpisodeObject
...
type _PagingSavedEpisodeObject PagingSavedEpisodeObject
...
func (o PagingSavedEpisodeObject) MarshalJSON() ([]byte, error) {
...
func (o PagingSavedEpisodeObject) ToMap() (map[string]interface{}, error) {
...
func (o *PagingSavedEpisodeObject) UnmarshalJSON(data []byte) (err error) {
	...
	varPagingSavedEpisodeObject := _PagingSavedEpisodeObject{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPagingSavedEpisodeObject)

	if err != nil {
		return err
	}

	*o = PagingSavedEpisodeObject(varPagingSavedEpisodeObject)

	return err
}

type NullablePagingSavedEpisodeObject struct {
	value *PagingSavedEpisodeObject
	isSet bool
}

func (v NullablePagingSavedEpisodeObject) Get() *PagingSavedEpisodeObject {
	return v.value
}

func (v *NullablePagingSavedEpisodeObject) Set(val *PagingSavedEpisodeObject) {
	v.value = val
	v.isSet = true
}

func (v NullablePagingSavedEpisodeObject) IsSet() bool {
	return v.isSet
}

func (v *NullablePagingSavedEpisodeObject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePagingSavedEpisodeObject(val *PagingSavedEpisodeObject) *NullablePagingSavedEpisodeObject {
	return &NullablePagingSavedEpisodeObject{value: val, isSet: true}
}

func (v NullablePagingSavedEpisodeObject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePagingSavedEpisodeObject) UnmarshalJSON(src []byte) error {
	v.isSet = true
