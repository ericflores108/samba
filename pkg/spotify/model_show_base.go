...
// checks if the ShowBase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShowBase{}

// ShowBase struct for ShowBase
...
func (o ShowBase) MarshalJSON() ([]byte, error) {
...
func (o ShowBase) ToMap() (map[string]interface{}, error) {
...
func (o *ShowBase) UnmarshalJSON(data []byte) (err error) {
	...
	varShowBase := _ShowBase{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varShowBase)

	if err != nil {
		return err
	}

	*o = ShowBase(varShowBase)

	return err
}

type NullableShowBase struct {
	value *ShowBase
	isSet bool
}

func (v NullableShowBase) Get() *ShowBase {
	return v.value
}

func (v *NullableShowBase) Set(val *ShowBase) {
	v.value = val
	v.isSet = true
}

func (v NullableShowBase) IsSet() bool {
	return v.isSet
}

func (v *NullableShowBase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShowBase(val *ShowBase) *NullableShowBase {
	return &NullableShowBase{value: val, isSet: true}
}

func (v NullableShowBase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShowBase) UnmarshalJSON(src []byte) error {
	v.isSet = true
