...
// checks if the PagingSavedShowObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PagingSavedShowObject{}

// PagingSavedShowObject struct for PagingSavedShowObject
...
func (o PagingSavedShowObject) MarshalJSON() ([]byte, error) {
...
func (o PagingSavedShowObject) ToMap() (map[string]interface{}, error) {
...
func (o *PagingSavedShowObject) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varPagingSavedShowObject)
...
type NullablePagingSavedShowObject struct {
	value *PagingSavedShowObject
	isSet bool
}

func (v NullablePagingSavedShowObject) Get() *PagingSavedShowObject {
	return v.value
}

func (v *NullablePagingSavedShowObject) Set(val *PagingSavedShowObject) {
	v.value = val
	v.isSet = true
}

func (v NullablePagingSavedShowObject) IsSet() bool {
	return v.isSet
}

func (v *NullablePagingSavedShowObject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePagingSavedShowObject(val *PagingSavedShowObject) *NullablePagingSavedShowObject {
	return &NullablePagingSavedShowObject{value: val, isSet: true}
}

func (v NullablePagingSavedShowObject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePagingSavedShowObject) UnmarshalJSON(src []byte) error {
	v.isSet = true
