...
// SetTracks gets a reference to the given PagingTrackObject and assigns it to the Tracks field.
func (o *Search200Response) SetTracks(v PagingTrackObject) {
	o.Tracks = &v
}
...
// SetArtists gets a reference to the given PagingArtistObject and assigns it to the Artists field.
...
// SetAlbums gets a reference to the given PagingSimplifiedAlbumObject and assigns it to the Albums field.
...
func (o *Search200Response) GetShows() PagingSimplifiedShowObject {
	if o == nil || IsNil(o.Shows) {
		var ret PagingSimplifiedShowObject
		return ret
	}
	return *o.Shows
}
...
// SetShows gets a reference to the given PagingSimplifiedShowObject and assigns it to the Shows field.
...
func (o *Search200Response) GetEpisodes() PagingSimplifiedEpisodeObject {
	if o == nil || IsNil(o.Episodes) {
		var ret PagingSimplifiedEpisodeObject
		return ret
	}
	return *o.Episodes
}
...
// SetEpisodes gets a reference to the given PagingSimplifiedEpisodeObject and assigns it to the Episodes field.
...
func (o *Search200Response) GetAudiobooks() PagingSimplifiedAudiobookObject {
	if o == nil || IsNil(o.Audiobooks) {
		var ret PagingSimplifiedAudiobookObject
		return ret
	}
	return *o.Audiobooks
}
...
// SetAudiobooks gets a reference to the given PagingSimplifiedAudiobookObject and assigns it to the Audiobooks field.
