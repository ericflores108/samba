...
// checks if the PagingSimplifiedAlbumObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PagingSimplifiedAlbumObject{}

// PagingSimplifiedAlbumObject struct for PagingSimplifiedAlbumObject
...
type _PagingSimplifiedAlbumObject PagingSimplifiedAlbumObject
...
func NewPagingSimplifiedAlbumObject(href string, limit int32, next NullableString, offset int32, previous NullableString, total int32, items []SimplifiedAlbumObject) *PagingSimplifiedAlbumObject {
	this := PagingSimplifiedAlbumObject{}
	this.Href = href
	this.Limit = limit
	this.Next = next
	this.Offset = offset
...
func (o *PagingSimplifiedAlbumObject) GetOffset() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
func (o PagingSimplifiedAlbumObject) MarshalJSON() ([]byte, error) {
...
func (o PagingSimplifiedAlbumObject) ToMap() (map[string]interface{}, error) {
...
func (o *PagingSimplifiedAlbumObject) UnmarshalJSON(data []byte) (err error) {
	...
	varPagingSimplifiedAlbumObject := _PagingSimplifiedAlbumObject{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPagingSimplifiedAlbumObject)

	if err != nil {
		return err
	}

	*o = PagingSimplifiedAlbumObject(varPagingSimplifiedAlbumObject)

	return err
}

type NullablePagingSimplifiedAlbumObject struct {
	value *PagingSimplifiedAlbumObject
	isSet bool
}

func (v NullablePagingSimplifiedAlbumObject) Get() *PagingSimplifiedAlbumObject {
	return v.value
}

func (v *NullablePagingSimplifiedAlbumObject) Set(val *PagingSimplifiedAlbumObject) {
	v.value = val
	v.isSet = true
}

func (v NullablePagingSimplifiedAlbumObject) IsSet() bool {
	return v.isSet
}

func (v *NullablePagingSimplifiedAlbumObject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePagingSimplifiedAlbumObject(val *PagingSimplifiedAlbumObject) *NullablePagingSimplifiedAlbumObject {
	return &NullablePagingSimplifiedAlbumObject{value: val, isSet: true}
}

func (v NullablePagingSimplifiedAlbumObject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePagingSimplifiedAlbumObject) UnmarshalJSON(src []byte) error {
	v.isSet = true
