...
// checks if the AudioFeaturesObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AudioFeaturesObject{}

// AudioFeaturesObject struct for AudioFeaturesObject
...
// GetAnalysisUrl returns the AnalysisUrl field value if set, zero value otherwise.
func (o *AudioFeaturesObject) GetAnalysisUrl() string {
	if o == nil || IsNil(o.AnalysisUrl) {
		var ret string
		return ret
	}
	return *o.AnalysisUrl
}

// GetAnalysisUrlOk returns a tuple with the AnalysisUrl field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AudioFeaturesObject) GetAnalysisUrlOk() (*string, bool) {
	if o == nil || IsNil(o.AnalysisUrl) {
		return nil, false
	}
	return o.AnalysisUrl, true
}
...
// SetAnalysisUrl gets a reference to the given string and assigns it to the AnalysisUrl field.
...
// GetTrackHref returns the TrackHref field value if set, zero value otherwise.
func (o *AudioFeaturesObject) GetTrackHref() string {
	if o == nil || IsNil(o.TrackHref) {
		var ret string
		return ret
	}
	return *o.TrackHref
...
// GetTrackHrefOk returns a tuple with the TrackHref field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AudioFeaturesObject) GetTrackHrefOk() (*string, bool) {
	if o == nil || IsNil(o.TrackHref) {
		return nil, false
	}
	return o.TrackHref, true
}
...
// SetTrackHref gets a reference to the given string and assigns it to the TrackHref field.
...
func (o AudioFeaturesObject) MarshalJSON() ([]byte, error) {
...
func (o AudioFeaturesObject) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Acousticness) {
		toSerialize["acousticness"] = o.Acousticness
	}
	if !IsNil(o.AnalysisUrl) {
		toSerialize["analysis_url"] = o.AnalysisUrl
	}
	...
	if !IsNil(o.TrackHref) {
		toSerialize["track_href"] = o.TrackHref
	}
	if !IsNil(o.Type) {
...
func (v NullableAudioFeaturesObject) Get() *AudioFeaturesObject {
	return v.value
}

func (v *NullableAudioFeaturesObject) Set(val *AudioFeaturesObject) {
	v.value = val
	v.isSet = true
}

func (v NullableAudioFeaturesObject) IsSet() bool {
	return v.isSet
}

func (v *NullableAudioFeaturesObject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAudioFeaturesObject(val *AudioFeaturesObject) *NullableAudioFeaturesObject {
	return &NullableAudioFeaturesObject{value: val, isSet: true}
}

func (v NullableAudioFeaturesObject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAudioFeaturesObject) UnmarshalJSON(src []byte) error {
	v.isSet = true
