...
type _PagingPlaylistObject PagingPlaylistObject
...
func (o *PagingPlaylistObject) UnmarshalJSON(data []byte) (err error) {
	...
	varPagingPlaylistObject := _PagingPlaylistObject{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPagingPlaylistObject)

	if err != nil {
		return err
	}

	*o = PagingPlaylistObject(varPagingPlaylistObject)
