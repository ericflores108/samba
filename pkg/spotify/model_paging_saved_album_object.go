...
// checks if the PagingSavedAlbumObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PagingSavedAlbumObject{}

// PagingSavedAlbumObject struct for PagingSavedAlbumObject
...
type _PagingSavedAlbumObject PagingSavedAlbumObject
...
func (o PagingSavedAlbumObject) MarshalJSON() ([]byte, error) {
...
func (o PagingSavedAlbumObject) ToMap() (map[string]interface{}, error) {
...
func (o *PagingSavedAlbumObject) UnmarshalJSON(data []byte) (err error) {
	...
	varPagingSavedAlbumObject := _PagingSavedAlbumObject{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPagingSavedAlbumObject)

	if err != nil {
		return err
	}

	*o = PagingSavedAlbumObject(varPagingSavedAlbumObject)

	return err
}

type NullablePagingSavedAlbumObject struct {
	value *PagingSavedAlbumObject
	isSet bool
}

func (v NullablePagingSavedAlbumObject) Get() *PagingSavedAlbumObject {
	return v.value
}

func (v *NullablePagingSavedAlbumObject) Set(val *PagingSavedAlbumObject) {
	v.value = val
	v.isSet = true
}

func (v NullablePagingSavedAlbumObject) IsSet() bool {
	return v.isSet
}

func (v *NullablePagingSavedAlbumObject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePagingSavedAlbumObject(val *PagingSavedAlbumObject) *NullablePagingSavedAlbumObject {
	return &NullablePagingSavedAlbumObject{value: val, isSet: true}
}

func (v NullablePagingSavedAlbumObject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePagingSavedAlbumObject) UnmarshalJSON(src []byte) error {
	v.isSet = true
